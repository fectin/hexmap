/* This module generates planet names. 
It is adapted from a name generator developed by Emily of www.fantasynamegenerators.com/
I am using her work here by special permission; she retains all rights to it. 

I release any rights I have in the transformation of this name generator; 
my contributions (and only MY contributions, NOT Emily's underlying work) are public domain.

Failing that, my contributions (and only MY contributions, not Emily's underlying work) are 
hereby licensed under The Creative Commons Public Domain Dedication (CC-0).
See https://creativecommons.org/publicdomain/zero/1.0/ for more info.

This means that you still need to ask permission at www.fantasynamegenerators.com/ before
using anything here, but you do NOT need my permission. 
...
function nameGen(){$('#placeholder').css('textTransform','capitalize');
	...
	for(i=0; i<10; i++){
		...
		} else if(i<8){rnd=Math.random()*nm1.length|0;
			rnd2=Math.random()*nm2.length|0;
